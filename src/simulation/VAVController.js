 ...
 *
 * Models VAV (Variable Air Volume) terminal boxes downstream of AHU-4-4_NEW,
 * following the same formula-driven pattern as AHU44NewController.js. Two
 * zones are modeled, both served by AHU-4-4_NEW (per its documented service
 * area: Pre-Function / Ballroom Level 2):
 *   - VAV-4-4-01 — Pre-Function
 *   - VAV-4-4-02 — Ballroom
 *
...
(function() {
  ...
  var ZONES = [
    { id: 'VAV-4-4-01', label: 'Pre-Function', servedBy: 'AHU-4-4_NEW' },
